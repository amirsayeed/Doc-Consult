    ...
    return (
        <div id='banner-div'>
            <div className='p-20 text-center space-y-8'>
                ...
                <form>
                    <input type="text" placeholder='Search any doctor' className=' text-black rounded-3xl w-1/2 p-2 bg-white'/>
                    <input type="submit" value="Search" className='btn btn-primary ml-2 rounded-3xl px-10'/>
                </form>

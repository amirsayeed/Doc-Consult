...
const ShowBooking = ({appointment}) => {
    const {name,education,consultation_fee} = appointment;
    
    return (
        <div className='w-full bg-base-100 p-6 rounded-2xl'>
        <div className='flex justify-between items-center'>
                <div className='flex flex-col items-start gap-2'>
                    <p className='font-bold text-xl'>{name}</p>
                    <p className='font-medium text-lg text-[#0F0F0F99]'>{education}</p>
                </div>
                <div>
